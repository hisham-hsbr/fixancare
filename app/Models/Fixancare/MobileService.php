...
class MobileService extends Model
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        ...
        if($run_seeder_disable=='Y'){
            ...
            ->logOnly(['code','name','local_name','description','date','job_number','job_type_id','contact_name','contact_number','contact_address','imei','lock','mobile_model_id','mobile_complaint_id','complaint_details','work_details','delivered_at','work_status_id','	job_status_id','payment','advance','balance','status','created_at','updated_at'])
