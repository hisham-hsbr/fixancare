                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="url" lable_class="required"
                                    label_name="URL" input_type="file" input_name="url" input_id="url" input_style=""
                                ...
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="description"
                                    lable_class="required" label_name="Description" input_type="text" input_name="description"
                                    input_id="description" input_style="" input_class=""
