...
Route::middleware('auth')->group(function () {
    ...
    Route::controller('Fixancare\FrontEndDataController')->prefix('/admin/fixancare/front-end-data')->name('front-end-data.')->group(function () {
        ...
        //job types
        Route::controller('Fixancare\JobTypeController')->prefix('/admin/fixancare/job-types')->name('job-types.')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/create', 'create')->name('create');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::patch('/update/{id}', 'update')->name('update');
        ...
        //mobile models
        Route::controller('Fixancare\MobileModelController')->prefix('/admin/fixancare/mobile-models')->name('mobile-models.')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/create', 'create')->name('create');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::patch('/update/{id}', 'update')->name('update');
        ...
        //brands
        Route::controller('Fixancare\BrandController')->prefix('/admin/fixancare/brands')->name('brands.')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/create', 'create')->name('create');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::patch('/update/{id}', 'update')->name('update');
